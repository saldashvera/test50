...
define(S_RULES, '<LI>Supported file types are: GIF, JPG, PNG
<LI>Maximum file size allowed is '.MAX_KB.' KB.
<LI>Images greater than '.MAX_W.'x'.MAX_H.' pixels will be thumbnailed.');				//Prints rules under posting section
...
define(S_FOOT, '- <a href="http://php.s3.to" target=_blank>GazouBBS</a> + <a href="http://www.2chan.net/" target=_blank>futaba</a> + <a href="http://www.mapored.com/futallaby/" target=_blank>futallaby</a> -'); //Prints footer (leave these credits)
...
define(S_MDTABLE2, '<th>Name</th><th>Comment</th><th>Host</th><th>Size<br>(Bytes)</th><th>md5</th>');	//Explains names for Management Panel (Name->md5)
define(S_RESET, 'Reset');										//Sets name for field reset button (global)
define(S_IMGSPACEUSAGE, 'Space used : <b>');						//Prints space used KB by the board under Management Panel
