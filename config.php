<?
define(TITLE, 'testing');		//Name of this image board
define(SQLLOG, 'imgboard');		//Table (NOT DATABASE) used by image board
define(SQLHOST, 'localhost');		//MySQL server address, usually localhost
define(SQLUSER, 'root');		//MySQL user (must be changed)
define(SQLPASS, '12345');		//MySQL user's password (must be changed)
define(SQLDB, 'test');		//Database used by image board
define(ADMIN_PASS, '12345');	//Janitor password  (CHANGE THIS YO)
...
define(HOME,  '../test');			//Site home directory (up one level by default
...
define(RE_COL, '789922');               //Color of replies (lines proceeded by greater than sign)
define(PHP_SELF, 'imgboard.php');	//Name of main script file
define(PHP_SELF2, 'imgboard.html');	//Name of main htm file
